...
{
    internal class CusCheckBox : CheckBox
    {
        //Fields
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (SolidBrush brushText = new SolidBrush(this.ForeColor))
            {
                ...
                g.DrawString(this.Text, this.Font, brushText, rbBorderSize, (this.Height - TextRenderer.MeasureText(this.Text, this.Font).Height) / 2);
            }
        }
